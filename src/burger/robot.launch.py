...
from launch_ros.actions import SetRemap  # 💡 1. SetRemap 모듈 추가
...
def generate_launch_description():
    ...
    namespace = LaunchConfiguration('namespace', default='tb3')
    ...
    return LaunchDescription([
        ...
        # 💡 2. TF 토픽을 글로벌(/tf)이 아닌 네임스페이스 내부(tb3/tf 등)로 강제 우회(Remap)
        ...
        IncludeLaunchDescription(
            ...
            # 💡 3. base_scan은 수정 없이 유지합니다. (위쪽 Namespace 설정과 자동 결합됨)
